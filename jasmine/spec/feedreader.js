...
$(function() {
    ...
    */
    ...
    /* A new test suite named "The menu" for the behavior of menu */
    ...
    describe('Initial Entries', function() {
        ...
        it("has atleast a single .entry element within the .feed container", function(done) { 
    ...
    describe('New Feed Selection', function() {
        ...
        it("changes the content", function(done) { 
            var feedhtml2 = $('.feed').html();
            expect(feedhtml1).toBeDefined();
            expect(feedhtml2).toBeDefined();
